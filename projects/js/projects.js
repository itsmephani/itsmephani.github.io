(function () {
  var projects = [
    ...
    {
      NAME: "Fx Trading Desktop",
      COMPANY: "CitiCorp Services",
      CLIENT: "",
      SPAN: "12/11/2018 - 23/12/2019",
      RESPONSIBILITIES: "Done UI part of the application.",
      LINK: "",
      DESCRIPTION: `Fx Desktop Trading application built with Electron, 
                    .Net, Angular. Application helps user to foresee G10 currency prices
                    and different events which affect the future trades. 
                    Application depicts the trend of prices in charts.
                    `,
    },
    {
      NAME: "LNMapper",
      ...
      CLIENT: "Google",
      SPAN: "13/08/2018 - 09/11/2018",
      RESPONSIBILITIES: "Done UI part of the application.",
      LINK: "",
      DESCRIPTION: `LNMapper a simple tool which lists all the records of the table 
                    and allows user to edit single or multiple mappings.`,
    },
    {
      NAME: "Workflow Quality",
      COMPANY: "HCL Technologies",
      CLIENT: "Google",
      SPAN: "08/08/2016 - 09/11/2018",
      RESPONSIBILITIES: "Done UI part of the application.",
      LINK: "",
    ...
    },
    {
      ...
      LINK:
        '<a href="https://play.google.com/store/apps/details?id=yopickup.yopickup" target="_blank" title="Playstore">Playstore</a>',
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Building REST API, Mobile App, Admin Panel, Product Inventory, Order Tracking.",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Created WordPress plugin for requesting, listing, accepting request of visit to wineyard by customer. Sending mail on approval.",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Building REST API, Integrating Facebook authentication, Video Transformation.",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Done fee, discussion forum, teacher substitution modules.",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Getting logs by subscribing to ActiveSupport Notification, Writing to Database, Admin view to list details of logs.",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Building API and client side UI of user settings, questions. Background jobs for sending notifications",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Building API and client side UI of Sales module, Bill module. Generating charts for sales, earnings",
      LINK: "",
    ...
    },
    {
      ...
      RESPONSIBILITIES:
        "Building API and client side UI of Exam slot booking, assignments",
      LINK: "",
  ...
  var PROJECT_HTML = `<div class="row">
  ...
  var renderProject = function (project, index) {
    ...
    projectDetails.forEach(function (detail) {
      if (!!project[detail]) {
        currentProjectHTML = currentProjectHTML.replace(
          "PROJECT_" + detail,
          project[detail]
        );
      } else {
        currentProjectHTML = currentProjectHTML.replace(
          "PROJECT" + detail + "_CLASS",
          "hidden"
        );
      }
    });
